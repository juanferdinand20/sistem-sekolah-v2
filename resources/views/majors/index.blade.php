    ...
    <table class="w-full text-left text-sm"> 
        <thead> 
            <tr class="border-b border-[#16213A] text-[11px] uppercase tracking-[0.15em] text-[#16213A]"> 
                ...
                <th class="w-64 px-5 py-3.5 font-semibold">Nama Jurusan</th> 
                <th class="px-5 py-3.5 font-semibold">Deskripsi</th> 
                <th class="w-40 px-5 py-3.5 text-right font-semibold">Tindakan</th> 
            </tr> 
        </thead> 
        <tbody> 
            ...
            <tr class="border-b border-[#EFEDE6] hover:bg-[#FAF9F5]">
                ...
                <td class="px-5 py-4 font-mono text-xs font-semibold text-[#16213A]">{{ $major['code'] }}</td>
                <td class="px-5 py-4 font-medium text-[#16213A]">{{ $major['name'] }}</td>
                <td class="px-5 py-4 text-slate-600 leading-relaxed">{{ $major['description'] }}</td>
                <td class="px-5 py-4">
            ...
            @empty
            <tr>
                <td colspan="5" class="px-5 py-8 text-center text-sm text-slate-500">Belum ada data jurusan.</td>
            </tr>
            @endforelse
        </tbody>
    </table> 
