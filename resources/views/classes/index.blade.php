    ...
    <table class="w-full text-left text-sm"> 
        ...
        <tbody> 
            ...
            <tr class="border-b border-[#EFEDE6] hover:bg-[#FAF9F5]">
                ...
                <td class="px-5 py-4 font-semibold text-[#16213A]">{{ $class['name'] }}</td>
                <td class="px-5 py-4 font-medium text-[#16213A]">{{ $class['grade'] }}</td>
                <td class="px-5 py-4 font-medium text-[#16213A]">{{ $class['major'] }}</td>
                <td class="px-5 py-4 text-slate-600">{{ $class['homeroom_teacher'] }}</td>
                <td class="px-5 py-4">
            ...
            @empty
            <tr>
                <td colspan="6" class="px-5 py-8 text-center text-sm text-slate-500">Belum ada data kelas.</td>
            </tr>
            @endforelse
        </tbody>
    </table> 
